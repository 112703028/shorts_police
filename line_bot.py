...
先了解一下你的喜好：**你覺得什麼樣的 YouTube Shorts 算是廢片、不值得看？**
直接打字跟我說，越具體越好（例如：太做作的煽情內容、AI生成的動物影片配罐頭旁白、標題誇大不實...）。

如果一時想不到，也可以參考幾類常見雷區，直接回數字（可複選，用逗號分開，例如 1,3）：
1️⃣ 心靈雞湯/勵志語錄　2️⃣ 開箱業配　3️⃣ AI生成動物/寵物　4️⃣ 標題黨/誇張縮圖　0️⃣ 都沒有，讓我用久了再學
